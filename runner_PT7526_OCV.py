...
from core.progress_report_PT7526 import ProgressReporter
import os

profile_parent_folder = "G:/My Drive/Cell Test Profiles/RPTs/PT7526_tuned_OCV_profiles"
savepath = "G:/My Drive/Cell Test Data/PT7526/OCVs"
temp = 25
test_title = 'PT7526_OCVs'

cqt_profile = "G:/My Drive/Cell Test Profiles/Utilities/CQT_H52_1C_4C.xml"
cqt_savepath = "G:/My Drive/Cell Test Data/PT7526/CQTs"
cqt_temp = 25

ack = input('This will perform OCV extraction. Confirm that prior to running this test, profile_editor_PT7526.py was run to generate new OCV profiles. Type YES to acknowledge:  ')
if ack != 'YES':
...
bank_request = input(f"Enter the banks for OCV extraction execution, separated by commas, or enter 'ALL' to use all {len(CONFIG.AVAILABLE_BANKS)} banks: ")
if bank_request == 'ALL':
...
message = f'''OCV extraction tests completed in both directions for PT-7526. All data saved to {savepath}.
