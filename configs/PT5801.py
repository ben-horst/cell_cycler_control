...
CHANNELS_PER_BANK = {   #active channel numbers for each bank
    ...
    #2702: [270101, 270102, 270205, 270206, 270207, 270208],
    2702: [270205, 270206, 270207, 270208],
    5201: [520101, 520102, 520103, 520104, 520105, 520106, 520107],
...
SPECIMENS_PER_BANK = {  #specimen IDs for each bank
    ...
    5201: ['T7C1R1', 'T7C1R2', 'T7C2R1', 'T7C2R2', 'T7C3R1', 'T7C3R2', 'T8C1R1'],
...
DISCHARGE_VARIED_STEP_POWER_NOM = 19  #power in W during varied part of nominal discharge profile
DISCHARGE_VARIED_STEP_POWER_EXT = 22  #power in W during varied part of extended discharge profile
